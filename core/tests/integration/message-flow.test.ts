...
describe('Message Flow Integration', () => {
    ...
    it('should handle bidirectional communication', async () => {
      ...
      const state: State = {
        attributes: [
          ...
          {
            name: 'Size',
            values: [{ value: 'Large', identifiers: ['lg'], isSelected: true }],
          },
        ],
      };
  ...
  describe('Message Queue Integration', () => {
          ...
          attributes: [
            {
              name: 'Size',
              values: [
                { value: 'Small', identifiers: ['sm'], isSelected: true },
              ],
            },
          ],
        },
    ...
    it('should handle message ordering correctly', async () => {
      ...
      expect(receivedMessages[1].type).toBe(
        VirtualDisplayRequestType.OBJECT_TREE
      );
  ...
  describe('Response Dispatcher Integration', () => {
    ...
    it('should handle mixed message types', async () => {
      ...
      const handler = (data: VirtualDisplayResponse): void => {
